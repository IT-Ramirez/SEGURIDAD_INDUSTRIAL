        ...
        <div class="container-fluid p-0">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex gap-2">
                    ...
                    <?php if (isset($_SESSION['username']) && $_SESSION['username'] === 'marco.stiker'): ?>
                    <a href="inspeccion_rapida.php" class="btn btn-info">
                        <i class="bi bi-lightning-fill me-1"></i> Inspección Rápida
                    </a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-hover align-middle table-eqx border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="py-3">
                                        <label class="fw-medium text-dark mb-2" for="nivel_combustible">Nivel de Combustible</label>
                                ...
                                <tr>
                                    <td class="py-3">
                                        <label class="fw-medium text-dark mb-2" for="ultimo_mantenimiento">Último mantenimiento</label>
                                        <input type="date" name="ultimo_mantenimiento" id="ultimo_mantenimiento" class="form-control" required>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
